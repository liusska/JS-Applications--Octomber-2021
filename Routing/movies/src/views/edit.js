...
const formTemplate = (movie, onSumbit) => html`       
    ...
    <div class="form-group">
        ...
        <textarea id="description" class="form-control" placeholder="Movie Description..." name="description" .value=${movie.description}></textarea>
    </div>
    <div class="form-group">
