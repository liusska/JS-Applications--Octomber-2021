function lockedProfile() {
    (async () => {
        ...
        Object.keys(profiles).forEach((key, i) => {
            ...
            let htmlPofile = createHtmlProfile(i + 1, profile.username, profile.email, profile.age);
            mainSection.appendChild(htmlPofile);
        });
    })();
    ...
    function createHtmlProfile(userIndex, username, email, age){
        ...
        showMoreBtn.addEventListener('click', shoeHiddenInfoHandler);
    ...
    function shoeHiddenInfoHandler(e){
